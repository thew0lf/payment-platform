...
```
DATABASE_URL=postgresql://postgres:WihjnWmVGDLSKaTaFVRhHQfuGSdfvPiw@centerbeam.proxy.rlwy.net:22511/railway
REDIS_URL=redis://default:ZfFOwQUtrHZyWYHKxRFkCKgcwEKRDoVs@turntable.proxy.rlwy.net:17936
```
