  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-medium text-zinc-300">Features ({(content.items || []).length})</h4>
        <button
          onClick={addItem}
        ...
        {(content.items || []).map((item, index) => (
          ...
          >
            ...
            >
              ...
              <span className="flex-1 text-sm text-white truncate">{item.title || 'Untitled'}</span>
