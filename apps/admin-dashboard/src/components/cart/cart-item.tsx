...
export function CartItem({
  ...
  return (
    <div
      className={cn(
        'flex gap-3 p-3 rounded-lg border border-border bg-card transition-opacity',
          ...
          <div className="flex items-center gap-1">
            {showSaveForLater && onSaveForLater && (
              <Button
                variant="ghost"
                size="sm"
                className="h-11 px-3 text-xs text-muted-foreground hover:text-foreground touch-manipulation"
...
export function SavedCartItem({
  ...
  return (
    <div
      className={cn(
        'flex gap-3 p-3 rounded-lg border border-border bg-card/50 transition-opacity',
        isLoading && 'opacity-60 pointer-events-none'
      )}
    >
      {/* Product Image */}
      ...
      <div className="flex flex-col gap-1">
        ...
        <Button
          variant="ghost"
          size="sm"
          className="h-11 px-3 text-xs text-muted-foreground hover:text-destructive touch-manipulation"
          onClick={() => onRemove(item.id)}
          disabled={isLoading}
