...
function StarterTemplate({ template, colors, gradient }: { template: TemplateGalleryItem; colors: typeof THEME_COLORS.STARTER; gradient: string }) {
  return (
    <>
      ...
      <header className="bg-white border-b border-border py-4 sticky top-14 z-40">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          <div className="text-foreground font-bold text-xl">YourBrand</div>
          <nav className="hidden md:flex items-center gap-8 text-muted-foreground">
            <a href="#features" className="hover:text-foreground transition-colors">Features</a>
            <a href="#pricing" className="hover:text-foreground transition-colors">Pricing</a>
            <a href="#about" className="hover:text-foreground transition-colors">About</a>
          </nav>
          <button className={cn('px-4 py-2 text-foreground rounded-lg transition-colors', colors.bg)}>
            Get Started
          </button>
        </div>
      </header>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className={cn('px-6 py-3 text-foreground rounded-lg font-medium', colors.bg)}>
                  Start Free Trial
                </button>
                <button className="px-6 py-3 border border-border text-muted-foreground rounded-lg font-medium hover:bg-muted transition-colors">
                  Watch Demo
                </button>
              </div>
            </div>
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-zinc-100 to-zinc-200 rounded-2xl flex items-center justify-center">
                <div className={cn('w-32 h-32 rounded-xl flex items-center justify-center', colors.bg)}>
                  <LayoutGrid className="h-16 w-16 text-foreground" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">Simple, powerful features for your business.</p>
          </div>
      ...
      <section className={cn('py-16 bg-gradient-to-r', gradient)}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-foreground/80 mb-8">Join thousands of happy customers today.</p>
          <button className="px-8 py-4 bg-white text-foreground rounded-lg font-semibold hover:bg-muted transition-colors">
      ...
      {/* Footer - Minimal */}
      <footer className="py-8 bg-card text-muted-foreground">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-foreground font-bold">YourBrand</div>
    ...
    <>
      ...
      <section className="relative bg-stone-900 py-32">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative">
          ...
          <button className="px-8 py-4 bg-amber-600 text-foreground rounded-none font-medium uppercase tracking-wide hover:bg-amber-700 transition-colors">
      ...
      <section className="py-20 bg-stone-900 text-foreground">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="text-stone-400">
            <span className="text-foreground font-medium">Emma Williams</span> &mdash; Interior Designer
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-4 py-2 bg-amber-600 text-foreground text-sm">Join</button>
              </div>
            </div>
          </div>
...
function VelocityTemplate({ template, colors, gradient }: { template: TemplateGalleryItem; colors: typeof THEME_COLORS.VELOCITY; gradient: string }) {
  return (
    <>
      ...
      <header className="bg-background border-b-4 border-red-600 py-4">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="text-foreground font-black text-2xl tracking-tight">VELOCITY</div>
          <nav className="hidden md:flex items-center gap-8 text-muted-foreground font-medium">
            <a href="#features" className="hover:text-foreground transition-colors">Features</a>
            <a href="#speed" className="hover:text-foreground transition-colors">Speed</a>
            <a href="#pricing" className="hover:text-foreground transition-colors">Pricing</a>
          </nav>
          <button className="px-6 py-2 bg-red-600 text-foreground font-bold uppercase tracking-wide hover:bg-red-700 transition-colors">
            Launch Now
          </button>
        </div>
      </header>
      ...
      <section className="relative bg-background py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="max-w-2xl">
            {template.isNew && (
              <span className="inline-flex items-center gap-2 px-4 py-1 bg-red-600 text-foreground text-sm font-bold uppercase mb-6">
                <Zap className="h-4 w-4" />
                New Release
              </span>
            )}
            <h1 className="text-5xl md:text-7xl font-black text-foreground mb-6 leading-none tracking-tight">
              MOVE<br />
            ...
            <div className="flex gap-4">
              <button className="px-8 py-4 bg-red-600 text-foreground font-bold uppercase tracking-wide hover:bg-red-700 transition-colors flex items-center gap-2">
                Get Started <ArrowRight className="h-5 w-5" />
              </button>
              <button className="px-8 py-4 border-2 border-border text-foreground font-bold uppercase tracking-wide hover:border-border transition-colors flex items-center gap-2">
      ...
      <section id="features" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-foreground mb-4">BUILT FOR SPEED</h2>
            <p className="text-muted-foreground text-lg">Everything you need to outpace the competition.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {template.features.slice(0, 6).map((feature, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-card p-6 border border-border hover:border-red-600 transition-colors group"
                >
                  <div className="w-14 h-14 bg-red-600/20 flex items-center justify-center mb-4 group-hover:bg-red-600 transition-colors">
                    <Icon className="h-7 w-7 text-red-500 group-hover:text-foreground transition-colors" />
                  </div>
      ...
      <section className="relative bg-background py-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative py-8">
          ...
          <button className="px-10 py-5 bg-background text-foreground font-black uppercase tracking-wide hover:bg-card transition-colors">
            Launch Now
          </button>
        </div>
      </section>
      ...
      {/* Footer - Minimal dark */}
      <footer className="py-8 bg-background border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-foreground font-black text-xl">VELOCITY</div>
          <div className="flex gap-8 text-muted-foreground text-sm font-medium">
            <a href="#" className="hover:text-foreground">Terms</a>
            <a href="#" className="hover:text-foreground">Privacy</a>
            <a href="#" className="hover:text-foreground">Support</a>
          </div>
          <div className="text-muted-foreground text-sm">&copy; 2024 Velocity Inc.</div>
        </div>
      </footer>
    </>
  );
  ...
  return (
    <>
      ...
      <header className="bg-background py-6">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          <div className="text-2xl font-light tracking-[0.3em] text-foreground">LUXE</div>
          <nav className="hidden md:flex items-center gap-10 text-muted-foreground text-sm tracking-widest uppercase">
      ...
      <section className="relative min-h-[80vh] bg-background flex items-center">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center relative">
          ...
          <h1 className="text-5xl md:text-7xl font-light text-foreground mb-8 tracking-wider">
            Exceptional<br />
      ...
      <section id="collection" className="py-24 bg-background">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl font-light text-foreground tracking-wide">Curated Excellence</h2>
          </div>
          <div className="space-y-16">
            {template.features.slice(0, 4).map((feature, idx) => {
              ...
              return (
                <div key={idx} className="flex items-start gap-8 group">
                  <div className="w-16 h-16 border border-border flex items-center justify-center flex-shrink-0 group-hover:border-amber-400 transition-colors">
                    <Icon className="h-6 w-6 text-amber-400" />
                  </div>
                  <div>
                    <h3 className="text-xl text-foreground mb-3 tracking-wide">{feature}</h3>
      ...
      <section id="boutique" className="py-24 bg-background">
        <div className="max-w-2xl mx-auto px-6 text-center">
          <span className="text-amber-400 text-xs tracking-[0.3em] uppercase mb-4 block">Private Consultation</span>
          <h2 className="text-4xl font-light text-foreground tracking-wide mb-6">Request an Appointment</h2>
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full px-6 py-4 bg-transparent border border-border text-foreground placeholder-zinc-600 focus:border-amber-400 outline-none transition-colors text-center"
            />
            <input
              type="email"
      ...
      <footer className="py-12 bg-background border-t border-zinc-900">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col items-center gap-8">
            <div className="text-2xl font-light tracking-[0.3em] text-foreground">LUXE</div>
            <div className="flex items-center gap-8 text-muted-foreground text-xs tracking-[0.2em] uppercase">
  ...
  if (!template) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center text-foreground">
        ...
        <p className="text-muted-foreground mb-8">The template &quot;{templateId}&quot; does not exist.</p>
        <button
          onClick={() => router.back()}
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className={cn('px-2 py-1 rounded text-xs font-medium text-foreground', colors.bg)}>
                {template.theme}
              </span>
