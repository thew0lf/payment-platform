          ...
          >
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-4 text-lg font-semibold text-white rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5"
                  ...
                  <div key={idx} className="bg-zinc-50 rounded-2xl p-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {testimonial.role && <p className="text-sm text-zinc-500">{testimonial.role}</p>}
                      </div>
                    </div>
                  </div>
                ))}
        ...
        {ctaSection && (
          <section className="py-16 px-4" style={{ backgroundColor: `${primaryColor}10` }}>
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-zinc-900 mb-4">{ctaSection.config.headline}</h2>
              <p className="text-lg text-zinc-600 mb-6">{ctaSection.config.subheadline}</p>
              ...
              <button
                onClick={advanceStage}
                className="inline-flex items-center gap-2 px-8 py-4 text-lg font-semibold text-white rounded-xl shadow-lg hover:shadow-xl transition-all"
                style={{ backgroundColor: primaryColor }}
              >
                {ctaText}
      ...
      <div className="min-h-screen bg-zinc-50 pb-24">
        ...
        <header className="bg-white border-b border-zinc-200 sticky top-0 z-10">
          <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
            <span className="font-semibold text-lg text-zinc-900">{funnel.company.name}</span>
        ...
        <main className="max-w-6xl mx-auto px-4 py-8">
          <h1 className="text-2xl font-bold text-zinc-900 mb-2">{currentStage.name}</h1>
          <p className="text-zinc-600 mb-8">Select the products you'd like to order</p>
          ...
          {products.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => {
                ...
                return (
                  <div key={product.id} className="bg-white rounded-xl border border-zinc-200 overflow-hidden hover:shadow-md transition-shadow">
                    {imageUrl && (
                    ...
                    {!imageUrl && (
                      <div className="aspect-square bg-zinc-100 flex items-center justify-center">
                        <Coffee className="w-16 h-16 text-zinc-300" />
                      </div>
                    )}
                    <div className="p-4">
                      <h3 className="font-semibold text-zinc-900 mb-1">{product.name}</h3>
                      {product.description && (
                        <p className="text-sm text-zinc-600 mb-3 line-clamp-2">{product.description}</p>
                      )}
        ...
        <div className="text-center max-w-md px-4">
          ...
          {checkoutResult.orderNumber && (
            <div className="bg-white rounded-xl p-4 shadow-sm border border-zinc-200 mb-6">
              ...
              <p className="text-lg font-mono font-semibold text-zinc-900">{checkoutResult.orderNumber}</p>
            </div>
          )}
        </div>
      </div>
                ...
                return (
                  <div key={step.key} className="flex items-center">
                    <div className={`flex items-center gap-2 px-4 py-2 rounded-full ${
                      isActive ? 'text-white' : isPast ? 'bg-green-100 text-green-700' : 'bg-zinc-100 text-zinc-400'
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              {checkoutStep === 'shipping' && (
                <form onSubmit={handleShippingSubmit}>
                  <div className="bg-white rounded-xl shadow-sm border border-zinc-200 p-6">
                    <h2 className="text-lg font-semibold text-zinc-900 mb-6">Shipping Information</h2>
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 border border-zinc-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-zinc-900 bg-white"
              ...
              {checkoutStep === 'payment' && (
                <form onSubmit={handlePaymentSubmit}>
                  <div className="bg-white rounded-xl shadow-sm border border-zinc-200 p-6">
                    <h2 className="text-lg font-semibold text-zinc-900 mb-6">Payment Details</h2>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full pl-12 pr-4 py-2.5 border border-zinc-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-zinc-900 bg-white"
                          placeholder="4242 4242 4242 4242"
                          maxLength={19}
                          required
                        />
                        <CreditCard className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-zinc-400" />
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="px-6 py-3 bg-zinc-100 text-zinc-700 rounded-lg font-medium hover:bg-zinc-200 transition-colors"
                      >
                        Back
                      </button>
                      <button
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm border border-zinc-200 p-6 sticky top-8">
                      ...
                      return (
                        <div key={productId} className="flex items-center justify-between text-sm">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-zinc-700">{product.name} <span className="text-zinc-400">x{qty}</span></span>
                          </div>
                          <span className="font-medium text-zinc-900">${(product.price * qty).toFixed(2)}</span>
                        </div>
                      );
                    })}
                  </div>
                ...
                <div className="py-4 space-y-2 border-b border-zinc-200">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-zinc-900">${summary?.subtotal?.toFixed(2) || getSelectedTotal().toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-600">Shipping</span>
                    <span className="text-zinc-900">{summary ? `$${summary.shippingAmount.toFixed(2)}` : 'Calculated next'}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-600">Tax</span>
                    <span className="text-zinc-900">{summary ? `$${summary.taxAmount.toFixed(2)}` : 'Calculated next'}</span>
                  </div>
                </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50">
      <div className="text-center">
        ...
        <p className="text-zinc-500">Stage type not supported: {currentStage.type}</p>
      </div>
    </div>
  );
}
