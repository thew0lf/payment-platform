    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Manage active subscriptions and recurring billing</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-center max-w-md">
          Subscription management with billing cycles, plan changes, and payment history is currently under development.
        </p>
      </div>
    </div>
  );
