        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                maxLength={32}
                className={cn(
                  'w-full pl-10 pr-4 py-2.5 bg-zinc-800 border rounded-lg text-sm text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50',
                  fieldErrors.code ? 'border-red-500' : 'border-zinc-700'
                )}
              />
            </div>
            {fieldErrors.code ? (
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5">
            ...
            <input
              ...
              maxLength={128}
              className={cn(
                'w-full px-4 py-2.5 bg-zinc-800 border rounded-lg text-sm text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50',
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  'w-full pl-10 pr-4 py-2.5 bg-zinc-800 border rounded-lg text-sm text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50',
                  fieldErrors.branch ? 'border-red-500' : 'border-zinc-700'
                )}
              />
            </div>
            {fieldErrors.branch ? (
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5">
            ...
            <textarea
              ...
              rows={4}
              maxLength={2000}
              className="w-full px-4 py-2.5 bg-zinc-800 border border-zinc-700 rounded-lg text-sm text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 resize-none"
            />
            <p className="mt-2 text-xs text-zinc-500">
