  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Continuity Framework</h1>
...
function OverviewTab() {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-900">Engineered Reality Framework</h2>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="border rounded-lg p-4">
          <h3 className="font-medium text-indigo-600 mb-2">PRIME</h3>
        ...
        <div className="border rounded-lg p-4">
          <h3 className="font-medium text-indigo-600 mb-2">FRAME</h3>
          <p className="text-sm text-gray-600">
        ...
        <div className="border rounded-lg p-4">
          <h3 className="font-medium text-indigo-600 mb-2">ANCHOR</h3>
          <p className="text-sm text-gray-600">
      ...
      <div className="border-t pt-6">
        <h3 className="font-medium text-gray-900 mb-4">Continuity Layer</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="border rounded-lg p-4 bg-gray-50">
            <h4 className="font-medium text-gray-900 mb-2">COMMIT</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            <h4 className="font-medium text-gray-900 mb-2">CONFIRM</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="border rounded-lg p-4 bg-gray-50">
            <h4 className="font-medium text-gray-900 mb-2">CLOSE</h4>
            <p className="text-sm text-gray-600">
...
function MomentumTab({
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-900">Behavioral Momentum</h2>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <label className="font-medium text-gray-900">Micro-Confirmations</label>
            <p className="text-sm text-gray-500">Show small success indicators at each step</p>
          </div>
          <Toggle
        ...
        <div>
          <label className="font-medium text-gray-900">Progress Indicator Style</label>
          <select
        ...
        <div>
          <label className="font-medium text-gray-900">Auto-Advance Delay (ms)</label>
          <input
            type="number"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
          />
          <p className="text-sm text-gray-500 mt-1">Time before auto-advancing to next step</p>
        </div>
      </div>
    </div>
  );
...
function TrustTab({
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-900">Trust Architecture</h2>
      <p className="text-gray-600">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <label className="font-medium text-gray-900">Security Indicators</label>
            <p className="text-sm text-gray-500">Show SSL/encryption badges</p>
          </div>
          <Toggle
        ...
        <div className="flex items-center justify-between">
          <div>
            <label className="font-medium text-gray-900">Social Proof</label>
            <p className="text-sm text-gray-500">Display transaction counts and ratings</p>
          </div>
          <Toggle
        ...
        <div>
          <label className="font-medium text-gray-900">Transaction Count Threshold</label>
          <input
            type="number"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
          />
          <p className="text-sm text-gray-500 mt-1">Minimum transactions before showing count</p>
        </div>

        <div>
          <label className="font-medium text-gray-900">Compliance Badges</label>
...
function FrictionTab({
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-900">Friction Calibration</h2>
      <p className="text-gray-600">
      ...
      <div className="space-y-4">
        <div>
          <label className="font-medium text-gray-900">One-Click Threshold ($)</label>
          <input
            type="number"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
          />
          <p className="text-sm text-gray-500 mt-1">Max amount eligible for one-click payment</p>
        </div>

        <div>
          <label className="font-medium text-gray-900">Confirmation Required ($)</label>
          <input
            type="number"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
          />
          <p className="text-sm text-gray-500 mt-1">Min amount requiring explicit confirmation</p>
        </div>

        <div>
          <label className="font-medium text-gray-900">Step-Up Auth Threshold ($)</label>
          <input
            type="number"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
          />
          <p className="text-sm text-gray-500 mt-1">Amount triggering additional authentication</p>
        </div>

        {/* Friction Visualization */}
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <h3 className="font-medium text-gray-900 mb-4">Friction Zones</h3>
...
function CognitiveTab({
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-900">Cognitive Continuity</h2>
      <p className="text-gray-600">
      ...
      <div className="space-y-4">
        <div>
          <label className="font-medium text-gray-900">Max Decision Points</label>
          <input
            type="number"
            min="1"
            max="10"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
          />
          <p className="text-sm text-gray-500 mt-1">Maximum choices presented in a single view</p>
        </div>

        <div className="flex items-center justify-between">
          <div>
            <label className="font-medium text-gray-900">Progressive Disclosure</label>
            <p className="text-sm text-gray-500">Reveal complexity gradually</p>
          </div>
          <Toggle
        ...
        <div className="flex items-center justify-between">
          <div>
            <label className="font-medium text-gray-900">Inline Validation</label>
            <p className="text-sm text-gray-500">Validate input without page reloads</p>
          </div>
          <Toggle
