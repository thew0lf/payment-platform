...
export class SubscriptionPlanService {
  ...
  private buildUpdateData(dto: UpdateSubscriptionPlanDto): any {
    ...
    const fields = [
      ...
      'miEnabled', 'miChurnDetectionEnabled', 'miChurnThresholdCritical',
      'miChurnThresholdHigh', 'miChurnThresholdMedium', 'miSaveFlowEnabled',
      'miSaveFlowMaxAttempts', 'miInterventionsEnabled', 'miInterventionTypes',
      'miSocialProofEnabled', 'miUrgencyEnabled', 'miUpsellEnabled',
      'miCrossSellEnabled', 'miPersonalizationEnabled',
      'metadata', 'status',
    ];
  ...
  private mapToPlan(data: any): SubscriptionPlan {
    return {
      ...
      // Momentum Intelligence
      miEnabled: data.miEnabled,
      miChurnDetectionEnabled: data.miChurnDetectionEnabled,
      miChurnThresholdCritical: data.miChurnThresholdCritical,
      miChurnThresholdHigh: data.miChurnThresholdHigh,
      miChurnThresholdMedium: data.miChurnThresholdMedium,
      miSaveFlowEnabled: data.miSaveFlowEnabled,
      miSaveFlowMaxAttempts: data.miSaveFlowMaxAttempts,
      miInterventionsEnabled: data.miInterventionsEnabled,
      miInterventionTypes: data.miInterventionTypes as string[],
      miSocialProofEnabled: data.miSocialProofEnabled,
      miUrgencyEnabled: data.miUrgencyEnabled,
      miUpsellEnabled: data.miUpsellEnabled,
      miCrossSellEnabled: data.miCrossSellEnabled,
      miPersonalizationEnabled: data.miPersonalizationEnabled,
